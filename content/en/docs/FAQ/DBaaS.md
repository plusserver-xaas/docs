...
---
# Table of contents
1. [Generelle Fragen](#GenerelleFragen)
  1. [Was sind DBaaS?](#GenerelleFragen1)
  2. [Was sind die unterstützten DBMS?](#GenerelleFragen2)
  3. [Kann ich DBaaS mit anderen Plusserver-Produkten verbinden?](#GenerelleFragen3)
  4. [Was ist eine Major- und eine Minorversion?](#GenerelleFragen4)
  5. [Wie kann ich die DBMS-Version bei der Erstellung einer DB-Instanz auswählen?](#GenerelleFragen5)
  6. [Kann ich eine neue Version vor dem Upgrade testen?](#GenerelleFragen6)
  7. [Wo kann ich die Produkt-Roadmap finden?](#GenerelleFragen7)
3. [Abrechnung](#Abrechnung)
  1. [Wie werden die Dienste abgerechnet?](#Abrechnung1)
  2. [Wo kann ich meine Rechnungen finden?](#Abrechnung2)
  3. [Was ist in den Preisen enthalten?](#Abrechnung3)
  4. [Wann beginnt und endet die Abrechnung?](#Abrechnung4)
4. [Bereitstellung](#Bereitstellung)

## Generelle Fragen <a name="GenerelleFragen"></a>
    ### F: Was sind DBaaS?
...
## Abrechnung <a name="Abrechnung"></a>
    ### F: Wie werden die Dienste abgerechnet? <a name="Abrechnung1"></a>
    ### A: Pay as you go 
    ### F: Wo kann ich meine Rechnungen finden? <a name="Abrechnung2"></a>
    ### F: Was ist in den Preisen enthalten? <a name="Abrechnung3"></a>
    ### F: Wann beginnt und endet die Abrechnung? <a name="Abrechnung4"></a>
